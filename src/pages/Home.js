...
const Home = () => {
  ...
  const title2 = "Leave Your Guests Speechless With Our Fabulous Food!";
  ...
  <div className="flex lg:flex-col flex-row items-center lg:justify-center lg:h-60 lg:w-54 h-16 w-[90%]  bg-white shadow-lg rounded-2xl p-6 shadow-[12px_12px_12px_12px_rgba(0,0,0,0.15)] shadow-[#951F44]">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-0 px-6">
      {/* Container 1 */}
      <div className="border-10 lg:border-t-10 lg:border-b-10 border-t-10 border-b-33 border-yellow-400 p-6 lg:rounded-lg flex flex-col items-center text-center">
      ...
      {/* Container 2 */}
      <div className="border-10 lg:border-t-10 lg:border-b-10 border-t-5 border-b-33 border-yellow-400 p-6 lg:rounded-lg flex flex-col items-center text-center">
      ...
      {/* Container 4 */}
      <div className="border-10 lg:border-t-10 lg:border-b-10 border-t-5 border-b-10 border-yellow-400 p-6 lg:rounded-lg flex flex-col items-center text-center">
